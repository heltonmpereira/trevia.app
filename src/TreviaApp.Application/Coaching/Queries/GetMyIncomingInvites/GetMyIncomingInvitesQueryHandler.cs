...
public sealed class GetMyIncomingInvitesQueryHandler : IQueryHandler<GetMyIncomingInvitesQuery, CoachingInvitesPagedResponse>
{
    private readonly IApplicationDbContext _db;
    private readonly ICurrentUserService _currentUser;
    private readonly ILogger<GetMyIncomingInvitesQueryHandler> _logger;

    public GetMyIncomingInvitesQueryHandler(
        IApplicationDbContext db,
        ICurrentUserService currentUser,
        ILogger<GetMyIncomingInvitesQueryHandler> logger)
    {
        _db = db;
    ...
    public async Task<CoachingInvitesPagedResponse> Handle(GetMyIncomingInvitesQuery request, CancellationToken cancellationToken)
    {
