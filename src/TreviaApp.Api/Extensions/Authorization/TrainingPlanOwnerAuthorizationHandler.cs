...
public class TrainingPlanOwnerAuthorizationHandler : AuthorizationHandler<IsTrainingPlanOwnerRequirement, Guid>
{
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, IsTrainingPlanOwnerRequirement requirement, Guid resourceTrainingPlanOwnerId)
    {
        ...
        {
            if (currentUserId == resourceTrainingPlanOwnerId) { context.Succeed(requirement); return Task.CompletedTask; }
        }
