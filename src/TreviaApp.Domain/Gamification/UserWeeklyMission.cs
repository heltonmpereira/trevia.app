...
public class UserWeeklyMission : Entity
{
    ...
    public WeeklyMissionDefinition Mission { get; private set; } = null!;
    ...
    private UserWeeklyMission()
    {
    }

    public UserWeeklyMission(Guid userId, Guid missionId, DateOnly weekStart)
    {
        UserId = userId;
        MissionId = missionId;
        WeekStart = weekStart;
