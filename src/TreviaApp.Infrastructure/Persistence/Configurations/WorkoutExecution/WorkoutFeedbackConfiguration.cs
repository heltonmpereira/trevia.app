...
public class WorkoutFeedbackConfiguration : IEntityTypeConfiguration<WorkoutFeedback>
{
    public void Configure(EntityTypeBuilder<WorkoutFeedback> b)
    {
        ...
        b.Property(w => w.IsPublic)
            .HasDefaultValue(true);

        b.Property(w => w.IsDeleted)
            .HasDefaultValue(false);

        b.HasIndex(w => new { w.StudentId, w.CreatedAt })
